...
["Dreaktwo"]="AX:(野性)4/0AT:(野性)2/0|0",
["Thirdrbt"]="AX:(野性)6/0AT:(野性)10/0|0",
["Dru"]="AX:(野性)3/0AT:(守护)1/0|0",
["Gintoki"]="AT:(守护)9/0|0",
...
["Nettles"]="AX:(恢复)13/0AT:(恢复)11/0|0",
["Moonglow"]="AT:(恢复)7/0|0",
["Adryz"]="AX:(恢复)9/0AT:(恢复)5/0|0",
["Aloeveras"]="AX:(恢复)11/0|0",
["Nonbinary"]="AX:(恢复)3/0AT:(恢复)1/0|0",
["Brainlag"]="AT:(恢复)10/0|0",
["Rozzitia"]="AX:(恢复)5/0AT:(恢复)8/0|0",
["Badkitty"]="AX:(恢复)7/0AT:(恢复)9/0|0",
["Jeppis"]="AX:(恢复)8/0AT:(恢复)4/0|0",
["Rengar"]="AX:(恢复)16/0|0",
["Metso"]="AX:(恢复)4/0AT:(恢复)3/0|0",
["Malfuriouso"]="AT:(恢复)13/0|0",
["Halvalkis"]="AX:(恢复)2/0AT:(恢复)6/0|0",
["Dupi"]="AT:(恢复)16/0|0",
["Cesco"]="AX:(恢复)14/0|0",
["Zoutchycream"]="AX:(恢复)6/0AT:(恢复)2/0|0",
["Astaria"]="AX:(恢复)1/0|0",
["Rethimnae"]="AT:(恢复)12/0|0",
...
["Icestyle"]="AX:(神圣)7/0AT:(神圣)2/0|0",
["Zgup"]="AX:(神圣)12/0AT:(神圣)11/0|0",
["Holyjimmy"]="AX:(神圣)9/0AT:(神圣)23/0|0",
["Greybeerd"]="AX:(神圣)3/0AT:(神圣)14/0|0",
["Freim"]="AX:(神圣)8/0AT:(神圣)9/0|0",
["Eksor"]="AT:(神圣)17/0|0",
["Might"]="AX:(神圣)15/0AT:(神圣)16/0|0",
["Desdemona"]="AT:(神圣)13/0|0",
["Gimmliz"]="AX:(神圣)11/0AT:(神圣)15/0|0",
["Rexus"]="AT:(神圣)22/0|0",
["Konghaakon"]="AX:(神圣)6/0AT:(神圣)8/0|0",
["Akilliam"]="AT:(神圣)10/0|0",
["Robinwôôd"]="AX:(神圣)13/0AT:(神圣)12/0|0",
["Aylonas"]="AX:(神圣)4/0AT:(神圣)3/0|0",
["Hally"]="AX:(神圣)14/0AT:(神圣)4/0|0",
["Illumition"]="AX:(神圣)16/0AT:(神圣)18/0|0",
["Alarion"]="AT:(神圣)19/0|0",
["Liwa"]="AX:(神圣)10/0AT:(神圣)7/0|0",
["Lemski"]="AX:(神圣)5/0AT:(神圣)6/0|0",
["Kraz"]="AT:(神圣)21/0|0",
["Yoú"]="AX:(神圣)2/0AT:(神圣)1/0|0",
["Helgrund"]="AX:(神圣)1/0AT:(神圣)5/0|0",
["Trulex"]="AX:(神圣)17/0AT:(惩戒)1/0|0",
["Bruxxus"]="LX:(神圣)34/0LT:(神圣)33/0|0",
["Quai"]="AX:(神圣)6/0AT:(神圣)1/0|0",
["Dremdol"]="AX:(神圣)10/0AT:(神圣)23/0|0",
["Arasuruv"]="AX:(神圣)5/0AT:(神圣)15/0|0",
["Fairytales"]="LX:(神圣)37/0AT:(神圣)20/0|0",
["Braqour"]="LT:(神圣)45/0|0",
["Miabuffs"]="LX:(神圣)36/0AT:(神圣)11/0|0",
["Shallows"]="AX:(神圣)17/0AT:(神圣)16/0|0",
["Hessey"]="AT:(神圣)25/0|0",
["Chado"]="LT:(神圣)43/0|0",
["Ismeria"]="AX:(神圣)15/0AT:(神圣)2/0|0",
["Liuralma"]="AX:(神圣)4/0AT:(神圣)6/0|0",
["Osho"]="LX:(神圣)32/0|0",
["View"]="AX:(神圣)14/0|0",
["Tiptop"]="AX:(神圣)19/0AT:(神圣)19/0|0",
["Unlucky"]="AX:(神圣)16/0AT:(神圣)14/0|0",
["Kordahn"]="AX:(神圣)2/0AT:(神圣)3/0|0",
["Madsiv"]="LX:(神圣)28/0LT:(神圣)39/0|0",
["Sykepleier"]="AX:(神圣)21/0AT:(神圣)22/0|0",
["Mavs"]="AX:(神圣)1/0|0",
["Doom"]="AX:(神圣)23/0LT:(神圣)32/0|0",
["Gupz"]="AX:(神圣)12/0LT:(神圣)38/0|0",
["April"]="AX:(神圣)25/0AT:(神圣)17/0|0",
["Zwiebelsaft"]="LT:(神圣)26/0|0",
["Yarehistory"]="AT:(神圣)21/0|0",
["Beautyelf"]="LT:(神圣)48/0|0",
["Serafhine"]="LT:(神圣)47/0|0",
["Lemur"]="LX:(神圣)30/0LT:(神圣)44/0|0",
["Stormkind"]="LX:(神圣)27/0AT:(神圣)13/0|0",
["Zyri"]="LT:(神圣)46/0|0",
["Mortheresa"]="AX:(神圣)11/0AT:(神圣)9/0|0",
["Samansaulic"]="AT:(神圣)18/0|0",
["Gynaika"]="AX:(神圣)3/0AT:(神圣)10/0|0",
["Brolav"]="LT:(神圣)29/0|0",
["Staciautyske"]="LX:(神圣)33/0LT:(神圣)30/0|0",
["Gorgias"]="AX:(神圣)9/0AT:(神圣)8/0|0",
["Xaron"]="LT:(神圣)40/0|0",
["Atlacamani"]="AX:(神圣)22/0LT:(神圣)31/0|0",
["Moosebeard"]="AX:(神圣)7/0AT:(神圣)7/0|0",
["Hyperbórea"]="AX:(神圣)18/0LT:(神圣)37/0|0",
["Boxy"]="LT:(神圣)34/0|0",
["Blueberryy"]="LT:(神圣)41/0|0",
["Misley"]="AX:(神圣)24/0|0",
["Girls"]="LT:(神圣)28/0|0",
["Metalianz"]="LX:(神圣)35/0LT:(神圣)36/0|0",
["Lorelei"]="LX:(神圣)26/0|0",
["Nogari"]="AX:(神圣)8/0AT:(神圣)4/0|0",
["Keev"]="LT:(神圣)35/0|0",
["Emenems"]="LX:(神圣)29/0AT:(神圣)5/0|0",
["Lumelina"]="LX:(神圣)31/0AT:(神圣)24/0|0",
["Holyfingers"]="AX:(神圣)20/0LT:(神圣)27/0|0",
["Soep"]="LT:(神圣)49/0|0",
["Ohnoimdead"]="LT:(神圣)42/0|0",
["Johana"]="AX:(神圣)13/0AT:(神圣)12/0|0",
["Fredger"]="AT:(暗影)1/0|0",
...
["Mommy"]="LT:(奇袭)62/0|0",
["Morrgrim"]="AX:(奇袭)10/0AT:(奇袭)10/0|0",
...
["Starn"]="LT:(奇袭)28/0|0",
["Snikt"]="AX:(奇袭)9/0AT:(奇袭)8/0|0",
["Roguezucc"]="LT:(奇袭)71/0|0",
["Sin"]="AX:(奇袭)8/0AT:(奇袭)19/0|0",
...
["Giler"]="AX:(恢复)22/0LT:(恢复)34/0|0",
["Mooselini"]="AX:(恢复)2/0AT:(恢复)1/0|0",
["Halalåke"]="AX:(恢复)8/0AT:(恢复)8/0|0",
["Sweetpeaches"]="AX:(恢复)5/0AT:(恢复)11/0|0",
["Noreen"]="AX:(恢复)24/0AT:(恢复)25/0|0",
["Knotje"]="AX:(恢复)19/0LT:(恢复)26/0|0",
["Emeshammy"]="AX:(恢复)12/0AT:(恢复)14/0|0",
["Lopettaja"]="AT:(恢复)20/0|0",
["Myuu"]="AX:(恢复)23/0AT:(恢复)16/0|0",
["Shockface"]="AX:(恢复)14/0AT:(恢复)12/0|0",
["Utility"]="AX:(恢复)17/0AT:(恢复)17/0|0",
["Arges"]="AX:(恢复)20/0|0",
["Kissmuffen"]="AX:(恢复)16/0AT:(恢复)18/0|0",
["Chamelem"]="AX:(恢复)25/0AT:(恢复)22/0|0",
["Wratje"]="LX:(恢复)26/0LT:(恢复)33/0|0",
["Negodzilla"]="AX:(恢复)15/0AT:(恢复)23/0|0",
["Shao"]="LT:(恢复)29/0|0",
["Ham"]="LT:(恢复)32/0|0",
["Halishock"]="AX:(恢复)10/0AT:(恢复)7/0|0",
["Bloodfeather"]="LT:(恢复)28/0|0",
["Chuck"]="AX:(恢复)21/0LT:(恢复)30/0|0",
["Denaia"]="AT:(恢复)19/0|0",
["Sanjii"]="AX:(恢复)13/0AT:(恢复)13/0|0",
["Windfuhrer"]="AX:(恢复)18/0AT:(恢复)24/0|0",
["Tigerberg"]="LT:(恢复)31/0|0",
["Kiwizou"]="AX:(恢复)7/0AT:(恢复)10/0|0",
["Scrò"]="AX:(恢复)9/0AT:(恢复)4/0|0",
["Shú"]="AT:(恢复)15/0|0",
["Send"]="AX:(恢复)6/0AT:(恢复)6/0|0",
["Thelman"]="AX:(恢复)1/0AT:(恢复)5/0|0",
["Hellshock"]="AX:(恢复)3/0AT:(恢复)2/0|0",
["Röcknrolla"]="LT:(恢复)36/0|0",
["Scro"]="AX:(恢复)11/0AT:(恢复)9/0|0",
["Bennorr"]="LT:(恢复)35/0|0",
["Athenee"]="AX:(恢复)4/0AT:(恢复)3/0|0",
["Atlas"]="AT:(恢复)21/0|0",
["Astarot"]="AX:(毁灭)6/0AT:(毁灭)16/0|0",
["Olivbnx"]="AT:(毁灭)12/0|0",
["Cranium"]="AT:(毁灭)15/0|0",
["Palpatin"]="AX:(毁灭)14/0|0",
["Gytha"]="AX:(毁灭)9/0AT:(毁灭)11/0|0",
["Magictso"]="AT:(毁灭)18/0|0",
...
["Böldpest"]="AX:(毁灭)13/0AT:(毁灭)17/0|0",
["Izar"]="AT:(毁灭)25/0|0",
["Valgash"]="AX:(毁灭)15/0AT:(毁灭)8/0|0",
["Heretic"]="AX:(毁灭)12/0AT:(毁灭)7/0|0",
...
["Jaybobay"]="LX:(狂怒)39/0LT:(狂怒)55/0|0",
["Parse"]="AX:(狂怒)3/0AT:(狂怒)3/0|0",
["Trouble"]="LX:(狂怒)74/0LT:(狂怒)58/0|0",
["Missmonique"]="LT:(狂怒)50/0|0",
["Jerzee"]="LT:(狂怒)85/0|0",
["Noblesse"]="AX:(狂怒)21/0AT:(狂怒)4/0|0",
["Dance"]="LT:(狂怒)78/0|0",
["Kdb"]="AX:(狂怒)12/0LT:(狂怒)51/0|0",
["Døden"]="LX:(狂怒)55/0LT:(狂怒)84/0|0",
["Ninefingers"]="AT:(狂怒)15/0|0",
["Stormgirl"]="LX:(狂怒)47/0LT:(狂怒)46/0|0",
["Canttwo"]="AX:(狂怒)15/0AT:(狂怒)17/0|0",
["Snafee"]="AX:(狂怒)5/0AT:(狂怒)7/0|0",
["Havoks"]="AX:(狂怒)23/0|0",
["Hailul"]="LT:(狂怒)30/0|0",
["Klinec"]="LT:(狂怒)34/0|0",
["Bodhixxl"]="LT:(狂怒)75/0|0",
["Deadlift"]="LT:(狂怒)70/0|0",
["Veclo"]="LX:(狂怒)64/0LT:(狂怒)66/0|0",
["Blomx"]="LT:(狂怒)41/0|0",
["Xixe"]="LX:(狂怒)69/0LT:(狂怒)44/0|0",
["Enber"]="AX:(狂怒)24/0AT:(狂怒)25/0|0",
["Kanye"]="LX:(狂怒)79/0LT:(狂怒)82/0|0",
["Notaunt"]="LX:(狂怒)32/0AT:(狂怒)20/0|0",
["Executie"]="LX:(狂怒)46/0LT:(狂怒)49/0|0",
["Gonk"]="AX:(狂怒)9/0AT:(狂怒)5/0|0",
["Bibbén"]="LT:(狂怒)45/0|0",
["Nashmey"]="ET:(狂怒)117/0|0",
["Curzon"]="LX:(狂怒)43/0LT:(狂怒)60/0|0",
["Warrian"]="LX:(狂怒)51/0LT:(狂怒)59/0|0",
["Bilz"]="LT:(狂怒)37/0|0",
["Kamaya"]="LX:(狂怒)52/0LT:(狂怒)74/0|0",
["Axeaxebaby"]="LT:(狂怒)57/0|0",
["Bløm"]="AX:(狂怒)17/0AT:(狂怒)14/0|0",
["Battlesmürff"]="LX:(狂怒)62/0LT:(狂怒)90/0|0",
["Pump"]="LT:(狂怒)42/0|0",
["Splifozaur"]="LX:(狂怒)30/0LT:(狂怒)32/0|0",
["Halifaks"]="LT:(狂怒)26/0|0",
["Terry"]="LX:(狂怒)63/0LT:(狂怒)76/0|0",
["Warrbringer"]="LX:(狂怒)59/0LT:(狂怒)81/0|0",
["Moojitsu"]="LX:(狂怒)73/0LT:(狂怒)65/0|0",
...
["Thunderfurre"]="LX:(狂怒)58/0LT:(狂怒)48/0|0",
["Knx"]="LX:(狂怒)56/0LT:(狂怒)54/0|0",
["Welwet"]="LX:(狂怒)37/0AT:(防护)9/0|0",
["Atlantida"]="AT:(防护)16/0|0",
["Flush"]="AX:(防护)4/0AT:(防护)3/0|0",
...
["Trenharder"]="AX:(防护)5/0AT:(防护)1/0|0",
